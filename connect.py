...
class Terrain(Canvas):
    ...
    def Horizontal(self):
        ...
        while (i < len(self.p)):
            j = 0
            while (j < 3):
                if (self.p[i][j].coul == self.p[i][j + 1].coul == self.p[i][j + 2].coul == self.p[i][
                        j + 3].coul == "red"):
                    info.t.config(text="Victoire de rouge !")
                    self.perm = False
                    break
                elif (self.p[i][j].coul == self.p[i][j + 1].coul == self.p[i][j + 2].coul == self.p[i][
                        j + 3].coul == "yellow"):
    ...
    def Vertical(self):
        ...
        while (i < 3):
            ...
            while (j < len(self.p[i])):
                if (self.p[i][j].coul == self.p[i + 1][j].coul == self.p[i + 2][j].coul == self.p[i + 3][
                    j].coul == "red"):
                    info.t.config(text="Victoire de rouge !")
                    self.perm = False
                    break
                elif (self.p[i][j].coul == self.p[i + 1][j].coul == self.p[i + 2][j].coul == self.p[i + 3][
                    j].coul == "yellow"):
                    info.t.config(text="Victoire de Jaune !")
                    self.perm = False
                    break
    ...
    def Diagonal1(self):
        ...
        while (i < 3):
            j = 0
            while (j < 3):
                if (self.p[i][j].coul == self.p[i + 1][j + 1].coul == self.p[i + 2][j + 2].coul == self.p[i + 3][
                        j + 3].coul == "red"):
                    info.t.config(text="Victoire de rouge !")
                    self.perm = False
                    break
                elif (self.p[i][j].coul == self.p[i + 1][j + 1].coul == self.p[i + 2][j + 2].coul == self.p[i + 3][
                        j + 3].coul == "yellow"):
                    info.t.config(text="Victoire de Jaune !")
                    self.perm = False
                    break
...
Button(root, text="Réinitialiser", command=rein).grid(row=0, column=0, pady=30)
